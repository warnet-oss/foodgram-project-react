    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('following', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='followed_users', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
